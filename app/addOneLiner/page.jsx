...
const AddOneLiner = ({ imageSrc, altText, displayText, onSubmit }) => {
      ...
      {textInputValue && (
        <div>
          <div className="flex flex-row justify-between">
            <h2 className="ml-4 mt-5">One Liner</h2>
            <Image
              src={"/Edit.svg"}
              alt={"Edit"}
              height={24}
          ...
          <p className="text-7xl">{textInputValue}</p>
        </div>
      )}
